...
<>
      <Button variant="primary" onClick={this.props.renderModal}>
        Add a Book
      </Button>

      <Modal show={this.state.showModal} onHide={this.props.hideModal}>
      ...
      // <Button onClick={this.props.renderModal}>Add A Book</Button>
      // <Modal show={this.state.showModal} onHide={this.props.hideModal}>
      //   <Modal.Dialog>
      //     <Modal.Header closeButton>
